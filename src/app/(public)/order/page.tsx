      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        {loading ? (
          ...
          <div className="text-center py-16 space-y-4">
            ...
            <h2 className="font-serif text-2xl text-charcoal">Online Ordering Coming Soon</h2>
            <p className="text-charcoal/60">Call us to place an order or visit us in person.</p>
            <a
              href="tel:+15551234567"
              className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-cream font-semibold rounded-sm hover:bg-primary-dark transition-colors"
            >
          ...
          <>
            <h2 className="text-center font-serif text-2xl text-charcoal mb-3">
              Choose Your Delivery Platform
            </h2>
            <p className="text-center text-charcoal/55 text-sm mb-12">
              ...
              {active.map((platform) => {
                ...
                return (
                  <a
                    ...
                    className="group bg-white rounded-sm border border-charcoal/10 p-8 flex flex-col items-center text-center shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300"
                  >
                    ...
                    <h3 className="font-serif text-2xl text-charcoal mb-2">{meta.name}</h3>
                    <p className="text-sm text-charcoal/55 mb-5 leading-relaxed">{meta.description}</p>
                    <ul className="text-xs text-charcoal/50 space-y-1.5 mb-6 text-left w-full">
                      {meta.features.map((f) => (
                    ...
                    <span className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 bg-charcoal text-cream font-semibold text-sm rounded-sm group-hover:bg-primary transition-colors">
